...
RAGMed — это инструмент для автоматической индексации и семантического поиска медицинских клинических протоколов. Система использует RAG-подход (Retrieval-Augmented Generation) для создания векторной базы данных, позволяющей находить релевантные протоколы по естественным запросам.
...
git clone https://github.com/luhverchikv/RAGMed.git
cd RAGMed
...
**Примечание**: RAGMed предоставляется как есть. Медицинские решения должны приниматься квалифицированными специалистами. Система предназначена для информационной поддержки, а не для замены профессиональной медицинской консультации.
